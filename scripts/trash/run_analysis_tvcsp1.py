...
for bamfile in sorted(bamlist) :
	...
	cmd = subprocess.Popen([
		'python', '/DATA/work/tvc5101sp1/bin/variant_caller_pipeline.py',
		'--input-bam',       bamfile,
		...
		'--error-motifs',	'/DATA/work/tvc5101sp1/share/TVC/sse/motifset.txt',
	...
	cmd = subprocess.Popen([
		'python', '/DATA/work/tvc5101sp1/bin/generate_variant_tables.py',
