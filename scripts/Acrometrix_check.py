...
suivi_acro_path = "/media/n06lbth/sauvegardes_pgm/SBT/EN_LAB_19_1731_Suivi_temoin_Acrometrix.xlsx"
...
# header 1
suivi_sheet.cell(row=8,column=column2write).value = sample+'_'+run_name
cell_format(suivi_sheet.cell(row=8,column=column2write),font='bold',alignment='center',border=True)

# header 2
suivi_sheet.cell(row=9,column=column2write).value = 'Var.freq'
cell_format(suivi_sheet.cell(row=9,column=column2write),border=True)
...
list_not_found = []
for i in range(9,len(suivi_rows)):
