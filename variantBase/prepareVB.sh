...
time python $NGS_PIPELINE_BX_DIR/variantBase/insert_all_panel_gene_variantbase.py | tee $NGS_PIPELINE_BX_DIR/variantBase/reannotation/logs/insert_all_panel_gene_variantbase.log.txt
echo "- insert_all_run_all_samples_variantbase.py"
time python $NGS_PIPELINE_BX_DIR/variantBase/insert_all_run_all_samples_variantbase.py | tee $NGS_PIPELINE_BX_DIR/variantBase/reannotation/logs/insert_all_run_all_samples_variantbase.log.txt
