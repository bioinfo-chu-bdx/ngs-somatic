...
abl1_c2g = {}
# %s/variantAnnotation/ABL1_NM_005157_cdna_genomic.tsv 
...
print " - [%s] %s variants (%s new entries, %s occurences added)" % (time.strftime("%H:%M:%S"),len(variants.keys()),new_var_count,new_vm_count)
